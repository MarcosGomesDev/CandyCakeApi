...
const changePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield User_1.default.findOne({ _id: validToken.id });
        ...
        console.log(passwordHash, user === null || user === void 0 ? void 0 : user.password);
        yield User_1.default.findOneAndUpdate({ _id: user === null || user === void 0 ? void 0 : user._id }, {
            $set: {
