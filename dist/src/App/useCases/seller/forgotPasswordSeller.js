...
const forgotPasswordSeller = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const token = yield TokenForgotPassword_1.default.findOne({ id: seller._id });
        if (token !== null) {
        ...
        console.log(link);
        yield (0, sendEmail_1.default)(seller.email, "Redefinir senha", `Seu código de redefinição de senha é: ${link}, Token válido por 5 minutos!`);
...
exports.default = forgotPasswordSeller;
